...
function playGame(e){
  ...
  // showing the result
  paras[0].textContent = `Your Choice: ${playerSelection}`;
  paras[1].textContent = `Computer Choice: ${computerSelection}`;
  paras[2].textContent = `${result}`;
  paras[3].textContent = `Your Score: ${playerScore}`;
  paras[4].textContent = `Computer Score: ${computerScore}`;
